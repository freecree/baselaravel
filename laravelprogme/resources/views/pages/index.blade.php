...
<section class="features">
    ...
    <div class="feature container work">
        <div class="feature__videoes">
            <div class="feature__video-main work__video-main">
                <img class="play" src="{{asset('pages/img/play.svg')}}" alt="play">
            </div>
            <div class="feature__bg"></div>
            <div class="work__video-sub sub-pic">
                <img src="{{asset('pages/img/worksub1.jpg')}}" alt="Video-sub">
                <img src="{{asset('pages/img/worksub2.png')}}" class="worksub2" alt="Video-sub">
            </div>
    ...
    <div class="feature defense indent-left">
        ...
        <div class="feature__videoes defense__video">
            <div class="feature__video-main defense__video-main ">
                <img class="play" src="{{asset('pages/img/play.svg')}}" alt="play">
            </div>
        </div>
    </div>
    ...
    <div class="feature we-white indent-left">
        <div class="feature__description">
            <div class="feature__heading we-white__heading">
                ...
                <img class="we-white__smile" src="{{asset('pages/img/smile.svg')}}" alt="Smile">
    ...
    <div class="container">
        ...
        <div class="parents">
            ...
            <div class="slider-parents">
                <img src="{{asset('pages/img/Alellopedigree.jpg')}}" alt="AkeloPedigree">
                <img src="{{asset('pages/img/GeraPedigree.jpg')}}" alt="GeraPedigree">
            </div>
        </div>
        ...
        <div class="growingup-dogs">
            ...
            <div class="growingup-dogs__block">
                <div class="growingup-dogs__dog nika">
                    <img src="{{asset('pages/img/nika.jpg')}}" alt="Nika">
                ...
                <div class="growingup-dogs__dog nura">
                    <img src="{{asset('pages/img/nura.jpg')}}" alt="Nura">
                    <div class="dog__description">
                        <h5 class="dog__name">
                ...
                <div class="growingup-dogs__dog nezhna">
                    <img src="{{asset('pages/img/nezhna.jpg')}}" alt="Nezhna">
                    <div class="dog__description">
                        <h5 class="dog__name">
        ...
        <div class="contacts-wrapper">
            ...
            <div class="contacts__text">
                ...
                <div class="contacts__string socials">
                    <img class="social" src="{{asset('pages/img/viber.svg')}}" alt="ICON">
                    <img class="social" src="{{asset('pages/img/telegram.svg')}}" alt="ICON">
                </div>
                <div class="contacts__string socials">
                    <img class="social" src="{{asset('pages/img/email.svg')}}" alt="ICON">
